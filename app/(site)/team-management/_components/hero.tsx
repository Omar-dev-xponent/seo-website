...
const Hero = () => {
  ...
  return (
    <section className="bg-[url(/team-management/hero-bg.png)] sm:py-10 py-8 md:py-20 bg-cover bg-no-repeat bg-center w-full">
      <div className="app-container">
        <div className="flex flex-col items-start justify-between w-full md:flex-row gap-7 md:gap-10 ">
          ...
          <div className="flex flex-col items-center justify-center w-full md:justify-start md:items-start md:w-1/2">
            <h1 className="text-3xl sm:text-4xl md:text-left text-center lg:text-5xl font-semibold lg:leading-[1.3] font-display text-typography-100">
              <span className="text-brand-100">Organize, assign</span> and{" "}
              <br className="hidden xl:block" />{" "}
              <span className="text-brand-100">collaborate</span> seamlessly
            </h1>
            <p className="mt-5 text-base text-center md:text-left sm:text-lg md:text-xl sm:mt-7 font-display text-typography-75">
              For agencies or teams, collaborate smoothly across{" "}
