      ...
      <div className="container px-4 md:px-6">
        <div className="flex flex-col items-center justify-center space-y-4 text-center">
          <div className="space-y-2">
            ...
            <h1 className="mx-auto max-w-4xl font-display text-5xl font-medium tracking-tight text-slate-900 sm:text-7xl mb-8">
              About{" "}
              <span className="relative whitespace-nowrap text-primary">
                ...
                <span className="relative">Outreachful</span>
              </span>
            </h1>
            <p className="mx-auto max-w-2xl text-lg tracking-tight text-slate-700">
              We're on a mission to simplify link building for SEO professionals
