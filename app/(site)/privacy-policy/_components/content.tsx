  ...
  return (
    <section className="w-full py-12 md:py-24 lg:py-32 bg-white">
      <div className="container px-4 md:px-6">
        <div className="mx-auto max-w-3xl prose prose-slate prose-headings:font-medium prose-headings:text-slate-900 prose-p:text-slate-700">
          <p className="text-slate-600 mb-6">
            Outreachful ("us", "we", or "our") operates the Outreachful platform
          ...
          <h2 className="text-2xl font-medium text-slate-900 mt-10 mb-4">
          ...
          <h4 className="text-lg font-medium text-slate-900 mt-6 mb-2">
            Personal Data
          </h4>
          ...
          <p className="text-slate-600 mb-6">Examples of Cookies we use:</p>
          ...
          <p className="text-slate-600 mb-6">
            Outreachful uses the collected data for various purposes:
          </p>
          ...
          <p className="text-slate-600 mb-6">
            Outreachful will take all steps reasonably necessary to ensure that
          ...
          <p className="text-slate-600 mb-6">
            Outreachful may disclose your Personal Data in the good faith belief
          ...
          <ul className="list-disc pl-6 text-slate-600 mb-6">
            ...
            <li>
              To protect and defend the rights or property of Outreachful.
            </li>
            <li>
          ...
          <ul className="list-disc pl-6 text-slate-600 mb-6">
            <li>By email: support@mail.outreachful.com</li>
            <li>
              By visiting this page on our website: www.outreachful.com/contact
            </li>
            <li>By phone: +1 (218) 231-1866</li>
            <li>By mail: 30 N Gould St Ste R Sheridan, WY, 82801, USA</li>
          </ul>
        </div>
      </div>
    </section>
